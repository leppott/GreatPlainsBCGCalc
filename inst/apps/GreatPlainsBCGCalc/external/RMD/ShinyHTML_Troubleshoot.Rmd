...
-   If running bug and fish calculations during the same session,
    forgetting to reset the assemblage in the drop-down menu. For
    example, if you run the bug BCG followed by the fish BCG, the bug
    selection does not automatically clear unless you refresh the
    webpage.
